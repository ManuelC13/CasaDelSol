...
<body>
    ...
    <div class="container formulario-contenedor mb-4 mt-5 shadow-lg p-4 rounded-3 bg-light col-xl-w-50 col bg col-md-5 col-lg-5 col-xl-6">
        <h1 class="fw-bold text-center mb-2">Actualizar datos</h1>
        ...
        <form id="formulario-registro" action="actualizarDatosUsuario.php" method="post" onsubmit="return validarContraseña()" class="needs-validation">
            ...
            <div class="text-center mt-3">
                <button type="submit" class="btn boton btn-success shadow"><i class="fa-solid fa-pen"></i> Actualizar mis datos</button>
            </div>
            <div class="text-center mt-3">
                <a href="../../usuario/administrador/menuDeAdministracion.php" class="btn btn-danger shadow">Cancelar</a>
            </div>
        </form>
    </div>
